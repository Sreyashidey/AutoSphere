        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Let Autosphere Drive You to Your Dream Car
            </h1>
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Advanced AI Car Search & Test Drive From Thousands of Vehicles – Only on Autosphere
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((type) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-600/40 to-transparent rounded-lg flex items-end">
